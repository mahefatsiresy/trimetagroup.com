 <div x-data="{ show: false }" @click.away="show = false">
     ...
     <div x-show="show" class="absolute z-50 w-24 pt-4 rounded-md bg-gray-950 text-gray-50" style="display: none">
         @foreach ($available_locales as $locale_name => $locale_value)
             <a href="lang/{{ $locale_value }}"
                 class="block px-3 py-4 hover:text-green-400 hover:font-semibold">{{ $locale_name }}</a>
         @endforeach
     </div>
