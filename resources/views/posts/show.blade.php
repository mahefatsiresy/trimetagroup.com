<x-layout :title="isset($error) ? __('common.cdn-error-title') : ($post ? $post['title'] : __('common.news.post.no-found'))" :description="isset($slug) ? __('common.' . $slug . '.meta-description') : ''" path="{{$path}}">
    @if (isset($error))
