<x-layout :title="isset($error) ? __('common.cdn-error-title') : ($post ? $post['title'] : __('common.news.post.no-found'))" :description="isset($slug) ? __('common.' . $slug . '.meta-description') : ''">
    @if (isset($error))
