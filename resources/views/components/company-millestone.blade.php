...
@if (0 === $index % 2)
    <li
        class="min-h-[142px] max-h-[150px] border border-neutral-800 px-12 rounded-full grid grid-cols-[1fr_48px_1fr] gap-8 mb-4 bg-neutral-100/80">
...
@else
    <li
        class="min-h-[142px] max-h-[150px] border border-neutral-800 rounded-full px-12 grid grid-cols-[1fr_48px_1fr] gap-8 mb-4 bg-neutral-100/80">
        <ul class="py-4 text-lg">
            @foreach ($company['abouts'] as $about)
                <li class="flex items-center gap-1 list-disc">
                    {{ $about }}
