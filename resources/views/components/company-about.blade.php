...
<x-fullpage-card class="bg-gray-100" :image="$background" index="0">
    <div class="mb-4 lg:max-w-[700px] pt-16">
        {{-- logo --}}
    ...
    @if (0 !== count($contacts))
        ...
        <div class="flex w-full md: grap mt-12 pb-8">
            <ul aria-label="contacts"
                class="grid justify-items-start gap-6 gap-x-12 lg:gap-12 md:grid-cols-2 w-fit text-lg text-gray-800">
                @foreach ($contacts as $contact)
                    @if ($contact)
                        <li class="flex gap-4 lg:gap-2">
